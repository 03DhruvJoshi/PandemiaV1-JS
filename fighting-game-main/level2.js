...
const background = new Sprite({
  ...
  imageSrc: './img/background/lvl2back.png',
})
...
const enemy = new Fighter({
  ...
  imageSrc: './img/corona2/corona_idle.png',
  framesMax: 4,
  scale: 3,
  offset: {
    x: -200,
  ...
  sprites: {
    idle: {
        imageSrc: './img/corona2/evilcorona_idle.png',
      framesMax: 4
    },
    takeHit: {
        imageSrc: './img/corona2/evilcorona_hit.png',
      framesMax: 4
    },
    attack1: {
        imageSrc: './img/corona2/evilcorona_attack.png',
      framesMax: 9
    }, 
    death: {
        imageSrc: './img/corona2/evilcorona_death.png',
      framesMax: 5
    }
  },
  attackBox: {
