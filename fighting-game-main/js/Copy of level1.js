...
const background = new Sprite({
  ...
  imageSrc: './img/background/lvl1back.png',
  scale: 1.18
})
...
const enemy = new Fighter({
  ...
  imageSrc: './img/corona1/corona_idle.png',
  framesMax: 4,
  scale: 3,
  offset: {
    x: -200,
  ...
  sprites: {
    ...
    takeHit: {
      imageSrc: './img/corona1/corona_hit.png',
      framesMax: 4
    },
    attack1: {
      imageSrc: './img/corona1/corona_attack1.png',
      framesMax: 4
    }, 
    death: {
      imageSrc: './img/corona1/corona_death.png',
      framesMax: 5
    }
  },
  attackBox: {
